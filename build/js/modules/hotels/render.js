...
(function () {
  ...
  if (template && container) {
    ...
    var addDescription = function (hotelElement, hotelData) {
      ...
      description.querySelector('.hotel-card__category-transcription').textContent = 'Hotel category: ' + hotelData.category + ' stars';
      description.querySelector('.hotel-card__category').appendChild(addStars(hotelData.category));
      description.querySelector('.hotel-card__rating').textContent = 'Rating: ' + hotelData.rating;
      description.querySelector('.hotel-card__type').textContent = hotelData.type;
      description.querySelector('.hotel-card__price').textContent = 'From ' + hotelData.cost + ' \u20BD';
    };
    ...
    var addPhoto = function (hotelElement, hotelData) {
      ...
      photo.alt = 'Hotel ' + hotelData.title;
    ...
    var renderMessage = function () {
      ...
      message.textContent = 'I could not find any hotels. Change your search criteria and try again!';
